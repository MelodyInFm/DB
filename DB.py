...
"""
CYBERGLITCH PRO - STABLE
- Надёжные эффекты (шум, битшифт, сортировка пикселей, RGB shift, блоки, постеризация, яркость/контраст, насыщенность)
- Параметр MIX (0-1) для каждого эффекта (смешивание с оригиналом)
- Маски (прямоугольник и многоугольник) работают
- Чёрно-красная тема, читаемые поля ввода
...
# ============================================================
# БИБЛИОТЕКА ЭФФЕКТОВ (ВСЕ С ПОДДЕРЖКОЙ MIX)
# ============================================================
...
# ============================================================
# ОПИСАНИЯ ЭФФЕКТОВ (добавлены новые, убраны текст и градиент)
# ============================================================
    ...
    def apply(self, img):
        ...
        for p in info['params']:
            ...
            if p['type'] == bool:
                ...
                val = float(val)
            # Преобразование для Channel Swap
...
# ============================================================
# ДИАЛОГИ МАСОК (ОСТАЛИСЬ БЕЗ ИЗМЕНЕНИЙ)
# ============================================================
...
# ============================================================
# ГЛАВНОЕ ПРИЛОЖЕНИЕ (СОХРАНЯЕМ СТАРУЮ СТРУКТУРУ)
# ============================================================

class CyberGlitchPro:
    def __init__(self, root):
        self.root = root
        self.root.title("CYBERGLITCH PRO - STABLE")
    ...
    def _load_preset(self):
        ...
        try:
            ...
            for item in preset_data:
                name = item['name']
                # Нормализация имени: убираем скобки и лишние пробелы
